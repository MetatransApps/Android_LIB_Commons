...
public interface IEvent_Base extends Serializable {
	...
	int MENU_OPERATION_CHANGE_MELODY			= 27;
	...
	IEvent_Base EVENT_MENU_OPERATION_CHANGE_MELODY = new Event_Base(
			MENU_OPERATION, MENU_OPERATION_CHANGE_MELODY,
			STR_MENU_OPERATION, "CHANGE_MELODY"
	);
